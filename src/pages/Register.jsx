    ...
    return (
      ...
      justifyContent: "center",
        ...
        <CustumBox key={"custom1"}>
          ...
          <Box key={"user"} sx={{ display: 'flex', alignItems: 'flex-end', margin:"19px 0" }}>
      ...
      <Button
              ...
              backgroundColor:"#F56A4D"},backgroundColor:"#FEEFEC",color:"black"}} 
                  ...
                  variant="contained"
                  >
                Or with Google <GoogleIcon sx={{marginLeft:"10px",}}></GoogleIcon>
                </Button>
  
                    </Box> 
  
          </form>
              <Typography  variant="overline"  sx={{ textAlign:"center", margin:"10px 0",  fontSize: "11px",
  }}>Already a user? <Typography component={"span"} variant="overline" sx={{borderBottom:"1px solid black",fontStyle:"bold","&:hover":{
      color:"#F56A4D"},cursor:
      "pointer"}}> Login</Typography></Typography>
        </CustumBox>
